...
class Highlight(Base):
    ...
    # An analogy that explains `text` in terms of something ordinary — printed under
    # the answer, never beside the question. Comprehension, not recall: explicitly not
    # a mnemonic, which would help recite a phrase without understanding it. Empty only
    # on rows distilled before hooks existed, until `digest.backfill_hooks` reaches them.
